...
class LinkedList:
    ...
    def multiplicacionlistas(self, a): 
        self.invertir()
        a.invertir()
        ...
        while P1!=None:
            ...
            if a.negative and (self.negative is False): # Asumo a-b, abs(a)>abs(b)
                if P2.data>P1.data:   # 0-1   -> 10-1
                    ...
                    desc = False
                multiplicacion = P1.data*P2.data
            else:
                multiplicacion = P1.data * P2.data
            multiplicacion = multiplicacion + sobrante # Si hay sobrante pasado agrega
            sobrante = 0 
            if multiplicacion>=10: 
                mul = multiplicacion%10
                sobrante = multiplicacion//10
                P1.data = str(mul)
                #Guarda suma en lista y sobrante para siguiente operación
            else:
                P1.data = str(abs(multiplicacion))
            P1 = P1.next
            P2 = P2.next
            # Avanzan por Nodos
        if sobrante>0:
